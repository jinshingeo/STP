"""
3D Space-Time Prism — v2_sdot (S-DoT 실측 기반)
=================================================
버전 히스토리:
  v1 (2026-03-18): 시간대 → A/B/C 시나리오 고정 매핑, 하드코딩 speed_factor
  v2_sdot (2026-04-01): link_utci_by_hour.csv 실측 speed_factor 사용
...
출력: figures/stp_3d_daily_v2_sdot.png
"""
...
plt.tight_layout()
out = os.path.join(FIG_DIR, "stp_3d_daily_v2_sdot.png")
